...
default_cfgs = dict(
    dm_nfnet_f0=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-dnf-weights/dm_nfnet_f0-604f9c3a.pth',
        pool_size=(6, 6),
    ...
    dm_nfnet_f1=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-dnf-weights/dm_nfnet_f1-fc540f82.pth',
        pool_size=(7, 7),
        input_size=(3, 224, 224),
    ...
    dm_nfnet_f2=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-dnf-weights/dm_nfnet_f2-89875923.pth',
        pool_size=(8, 8),
    ...
    dm_nfnet_f3=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-dnf-weights/dm_nfnet_f3-d74ab3aa.pth',
        pool_size=(10, 10),
    ...
    dm_nfnet_f4=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-dnf-weights/dm_nfnet_f4-0ac5b10b.pth',
        pool_size=(12, 12),
    ...
    dm_nfnet_f5=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-dnf-weights/dm_nfnet_f5-ecb20ab1.pth',
        pool_size=(13, 13),
    ...
    dm_nfnet_f6=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-dnf-weights/dm_nfnet_f6-e0f12116.pth',
        pool_size=(14, 14),
    ...
    nfnet_l0=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/nfnet_l0_ra2-45c6688d.pth',
        pool_size=(7, 7),
        input_size=(3, 224, 224),
    ...
    eca_nfnet_l0=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/ecanfnet_l0_ra2-e3e9ac50.pth',
    ...
    eca_nfnet_l1=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/ecanfnet_l1_ra2-7dce93cd.pth',
        pool_size=(8, 8),
        input_size=(3, 256, 256),
        test_input_size=(3, 320, 320),
        crop_pct=1.0),
    eca_nfnet_l2=_dcfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/ecanfnet_l2_ra3-da781a61.pth',
        pool_size=(10, 10),
        input_size=(3, 320, 320),
        test_input_size=(3, 384, 384),
        crop_pct=1.0),
    eca_nfnet_l3=_dcfg(url='',
                       pool_size=(11, 11),
    ...
    nf_regnet_b1=_dcfg(
        ...
        input_size=(3, 256, 256),
        test_input_size=(3, 288, 288),
        first_conv='stem.conv'),  # NOT to paper spec
    nf_regnet_b2=_dcfg(url='',
                       pool_size=(8, 8),
                       input_size=(3, 240, 240),
                       test_input_size=(3, 272, 272),
                       first_conv='stem.conv'),
    nf_regnet_b3=_dcfg(url='',
                       pool_size=(9, 9),
                       input_size=(3, 288, 288),
                       test_input_size=(3, 320, 320),
                       first_conv='stem.conv'),
    nf_regnet_b4=_dcfg(url='',
                       pool_size=(10, 10),
                       input_size=(3, 320, 320),
                       test_input_size=(3, 384, 384),
                       first_conv='stem.conv'),
    nf_regnet_b5=_dcfg(url='',
                       pool_size=(12, 12),
                       input_size=(3, 384, 384),
...
def _nfnet_cfg(depths,
    ...
    attn_kwargs = attn_kwargs if attn_kwargs is not None else dict(
        rd_ratio=0.5)
    cfg = NfCfg(depths=depths,
                channels=channels,
                stem_type='deep_quad',
...
model_cfgs = dict(
    ...
    nfnet_l0=_nfnet_cfg(depths=(1, 2, 6, 3),
                        feat_mult=1.5,
                        group_size=64,
                        bottle_ratio=0.25,
                        attn_kwargs=dict(rd_ratio=0.25, rd_divisor=8),
                        act_layer='silu'),
    eca_nfnet_l0=_nfnet_cfg(depths=(1, 2, 6, 3),
                            feat_mult=1.5,
                            group_size=64,
                            bottle_ratio=0.25,
                            attn_layer='eca',
                            attn_kwargs=dict(),
                            act_layer='silu'),
    eca_nfnet_l1=_nfnet_cfg(depths=(2, 4, 12, 6),
                            feat_mult=2,
                            group_size=64,
                            bottle_ratio=0.25,
                            attn_layer='eca',
                            attn_kwargs=dict(),
                            act_layer='silu'),
    eca_nfnet_l2=_nfnet_cfg(depths=(3, 6, 18, 9),
                            feat_mult=2,
                            group_size=64,
                            bottle_ratio=0.25,
                            attn_layer='eca',
                            attn_kwargs=dict(),
                            act_layer='silu'),
    eca_nfnet_l3=_nfnet_cfg(depths=(4, 8, 24, 12),
                            feat_mult=2,
                            group_size=64,
                            bottle_ratio=0.25,
                            attn_layer='eca',
    ...
    nf_regnet_b4=_nfreg_cfg(depths=(2, 6, 11, 11),
                            channels=(64, 144, 288, 616)),
    nf_regnet_b5=_nfreg_cfg(depths=(3, 7, 14, 14),
                            channels=(80, 168, 336, 704)),
    # FIXME add B6-B8
    ...
    nf_seresnet26=_nfres_cfg(depths=(2, 2, 2, 2),
                             attn_layer='se',
                             attn_kwargs=dict(rd_ratio=1 / 16)),
    nf_seresnet50=_nfres_cfg(depths=(3, 4, 6, 3),
                             attn_layer='se',
                             attn_kwargs=dict(rd_ratio=1 / 16)),
    nf_seresnet101=_nfres_cfg(depths=(3, 4, 23, 3),
                              attn_layer='se',
                              attn_kwargs=dict(rd_ratio=1 / 16)),
    nf_ecaresnet26=_nfres_cfg(depths=(2, 2, 2, 2),
                              attn_layer='eca',
                              attn_kwargs=dict()),
    nf_ecaresnet50=_nfres_cfg(depths=(3, 4, 6, 3),
                              attn_layer='eca',
                              attn_kwargs=dict()),
    nf_ecaresnet101=_nfres_cfg(depths=(3, 4, 23, 3),
                               attn_layer='eca',
                               attn_kwargs=dict()),
)
...
class NormFreeBlock(nn.Module):
    ...
    def __init__(self,
        ...
        if reg and attn_layer is not None:
            ...
            self.attn = None
        self.act3 = act_layer()
        self.conv3 = conv_layer(mid_chs,
                                out_chs,
                                1,
                                gain_init=1. if skipinit else 0.)
...
def create_stem(in_chs,
    ...
    if 'deep' in stem_type:
        if 'quad' in stem_type:
            ...
            strides = (2, 1, 1, 2)
            stem_stride = 4
            stem_feature = dict(num_chs=out_chs // 2,
                                reduction=2,
                                module='stem.conv3')
        else:
        ...
        for i, (c, s) in enumerate(zip(stem_chs, strides)):
            stem[f'conv{i + 1}'] = conv_layer(in_chs,
                                              c,
                                              kernel_size=3,
                                              stride=s)
            if i != last_idx:
...
class NormFreeNet(nn.Module):
    ...
    def __init__(self,
        ...
        for stage_idx, stage_depth in enumerate(cfg.depths):
            stride = 1 if stage_idx in [0, 3] and stem_stride > 2 else 2
...
def _create_normfreenet(variant, pretrained=False, **kwargs):
    ...
    return build_model_with_cfg(NormFreeNet,
                                variant,
                                pretrained,
...
def build_nfnet_backbone(cfg):
    """
    Create a NFNet instance from config.
    Returns:
        NFNet: a :class:`NFNet` instance.
    """
    ...
    model = _create_normfreenet(depth, pretrained=pretrain)
    # if pretrain:
...
if __name__ == '__main__':
    ...
    model = nf_resnet50(pretrained=True)
    # model = _create_normfreenet('dm_nfnet_f3')
